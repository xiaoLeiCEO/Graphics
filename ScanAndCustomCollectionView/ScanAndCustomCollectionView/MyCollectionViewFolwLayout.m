...
@interface MyCollectionViewFolwLayout(){
    CGFloat _viewHeight;
    CGFloat _itemHeight;
}
...
@implementation MyCollectionViewFolwLayout
...
- (UICollectionViewLayoutAttributes *)layoutAttributesForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    CGFloat delta = fabs(cY - attributesY);
    
    CGFloat ratio = delta / (_itemHeight * 2);
    
    CGFloat scale = cos(ratio * M_PI_2);
